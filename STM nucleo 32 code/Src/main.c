...
int main(void)
{
  ...
  //----------------------DCDC PWM settings----------------------------------------
   PWM_Period_DCAC = 64000000/(2*PWM_Freq_DCDC)-1;
...
voltage_meas_adc1 = (voltage_raw_adc1 / 4096.0f) *3.3f;
current_meas_adc1 = (current_raw_adc1 / 4096.0f) *3.3f;
...
voltage_meas_adc2 = (voltage_raw_adc2 / 4096.0f) *3.3f;
current_meas_adc2 = (current_raw_adc2 / 4096.0f) *3.3f;
