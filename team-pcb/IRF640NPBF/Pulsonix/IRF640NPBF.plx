...
(library Library_1
	...
	(compDef "IRF640NPBF" (originalName "IRF640NPBF") (compHeader (numPins 3) (numParts 1) (refDesPrefix U)
		...
		(compPin "2" (pinName "SOURCE") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "DRAIN") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/IRF640NPBF.pdf")
		(attr "<Component Height>" "4.83")
		(attr "<STEP Filename>" "IRF640NPBF.stp")
