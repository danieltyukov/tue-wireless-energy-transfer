...
int main(void)
{
  ...
  while (1)
  {
		...
		PWM_DutyC_DCDC = PWM_DutyC_DCDC-1;
		PWM_Pulsewidth_DCDC = (int)((PWM_Period_DCDC*PWM_DutyC_DCDC)/100);
		__HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_1, PWM_Pulsewidth_DCDC);
		}
// function incrementing Dutycycle till max
...
meas_1 = (((float)raw_meas_1) / 4095.0f) *3.3f*20;
meas_2 = (((float)raw_meas_2) / 4095.0f) *3.3f*20*1000;
meas_3 = (((float)raw_meas_3) / 4095.0f) *3.3f*20;
}
/* USER CODE END 4 */
